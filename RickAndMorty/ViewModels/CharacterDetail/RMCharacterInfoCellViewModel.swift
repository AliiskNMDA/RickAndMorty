   ...
   // Пример даты в формате JSON
    ...
    enum  `Type`: String  {
        ...
        var tintColor: UIColor? {
            ...
            case .species: return .systemPurple
            case .origin: return .systemIndigo
            case .location: return .systemCyan
            case .created: return .systemPink
            case .episodeCount: return .systemTeal
            }
        }
